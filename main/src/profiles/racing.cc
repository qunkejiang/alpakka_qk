...
void config_profile_default_racing(CtrlProfile *profile){
    ...
    profile->sections[SECTION_RSTICK_LEFT].button = (CtrlButton){
        .mode=NORMAL,
        .actions={GAMEPAD_AXIS_RX_NEG, PROC_ROTARY_MODE_1, 0, 0},
        .actions_secondary={0, 0, 0, 0},
        .actions_terciary={0, 0, 0, 0},
        .hint="",
        .hint_secondary={0},
    ...
    profile->sections[SECTION_RSTICK_RIGHT].button = (CtrlButton){
        .mode=NORMAL,
        .actions={GAMEPAD_AXIS_RX, PROC_ROTARY_MODE_3, 0, 0},
        .actions_secondary={0, 0, 0, 0},
        .actions_terciary={0, 0, 0, 0},
        .hint="",
        .hint_secondary={0},
    ...
    profile->sections[SECTION_RSTICK_UP].button = (CtrlButton){
        .mode=NORMAL,
        .actions={GAMEPAD_AXIS_RY_NEG, PROC_ROTARY_MODE_4, 0, 0},
        .actions_secondary={0, 0, 0, 0},
        .actions_terciary={0, 0, 0, 0},
        .hint="",
        .hint_secondary={0},
    ...
    profile->sections[SECTION_RSTICK_DOWN].button = (CtrlButton){
        .mode=NORMAL,
        .actions={GAMEPAD_AXIS_RY, PROC_ROTARY_MODE_2, 0, 0},
        .actions_secondary={0, 0, 0, 0},
        .actions_terciary={0, 0, 0, 0},
        .hint="",
        .hint_secondary={0},
    ...
    profile->sections[SECTION_RSTICK_PUSH].button = (CtrlButton){
        .mode=NORMAL,
        .actions={KEY_R, PROC_ROTARY_MODE_0, 0, 0},
        .actions_secondary={0, 0, 0, 0},
        .actions_terciary={0, 0, 0, 0},
        .hint="",
        .hint_secondary={0},
    ...
    profile->sections[SECTION_ROTARY_UP].rotary = (CtrlRotary){
        .actions_0={GAMEPAD_UP, 0, 0, 0},
        .actions_1={KEY_PAD_1, 0, 0, 0},
        .actions_2={KEY_PAD_3, 0, 0, 0},
        .actions_3={KEY_PAD_5, 0, 0, 0},
        .actions_4={KEY_PAD_7, 0, 0, 0},
        .hint_0="MDF Up",
        .hint_1="TC+",
        .hint_2="ABS+",
        .hint_3="BB+",
    ...
    profile->sections[SECTION_ROTARY_DOWN].rotary = (CtrlRotary){
        .actions_0={GAMEPAD_DOWN, 0, 0, 0},
        .actions_1={KEY_PAD_2, 0, 0, 0},
        .actions_2={KEY_PAD_4, 0, 0, 0},
        .actions_3={KEY_PAD_6, 0, 0, 0},
        .actions_4={KEY_PAD_8, 0, 0, 0},
        .hint_0="MDF Down",
        .hint_1="TC-",
        .hint_2="ABS-",
        .hint_3="BB-",
    ...
    profile->sections[SECTION_GYRO_X].gyro_axis = (CtrlGyroAxis){
        .actions_neg={GAMEPAD_AXIS_LX_NEG, 0, 0, 0},
        .actions_pos={GAMEPAD_AXIS_LX, 0, 0, 0},
        .angle_min=-90,
        .angle_max=90,
        .hint_neg="",
        .hint_pos="Steering",
