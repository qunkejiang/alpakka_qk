...
extern bool get_var_kbm_state();
extern void set_var_kbm_state(bool value);
...
extern int32_t get_var_joystick_calibration();
extern void set_var_joystick_calibration(int32_t value);
